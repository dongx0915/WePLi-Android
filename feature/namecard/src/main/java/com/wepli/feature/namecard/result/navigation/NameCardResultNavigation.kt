...
// Controller
fun NavController.navigateToNameCardResult(nameCardInfo: NameCardUiData) {
...
fun NavGraphBuilder.nameCardResultGraph(
    ...
    composable(
        ...
        val nameCardInfo = it.arguments?.getString("nameCardInfo")?.parseFromJson<NameCardUiData>()
